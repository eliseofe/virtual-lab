...
The living **#273 — UI/UX refinement** lane has completed the Product Design activation through #423–#430 plus the evidence-driven refinements #437, #440 and #444. The accepted result is a focused global ribbon plus one task-based Experiment Control panel with balanced proportions, consistent action sizing and prose-free primary cards. Numbered revisions display only their number in the compact revision trigger; Working copy uses a compact marker with descriptive context retained in accessibility metadata. The local #444 audit also removed stale Control Panel integration glue left by earlier Save Revision, Organize and Save-as-new relocations and repaired Showcase to target the authoritative Save Revision control. Simulation/Arena and Experiment Source/Authoring remain otherwise unchanged. #273 is **dormant / living** until new concrete usage evidence appears; #425 remains dormant and no repo-wide refactor has been activated.

## Immediate frontier

1. **#273 UI/UX is dormant / living after the completed Control-panel activation and direct-use refinements #437/#440/#444.** No UI/UX child is currently executable; future work should be triggered by concrete use evidence rather than an automatic redesign successor.
