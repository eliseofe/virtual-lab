...
The aggregation case exposed both capability-flow defects and a scientific-context problem. #310–#312, #323/#324, diagnostic #327 and protocol-visibility repair #328 are complete. The fresh-chat follow-up then showed that exposing raw historical request context can feed a later research AI its own earlier scientific reasoning. Cleanup epic #330 remains active before acceptance resumes. #331 audited the full research-AI-visible surface; #332 froze the minimal scientific boundary; #333 and #334 are historical transition steps. Canonical-capability transition epic #343 is complete through #344–#348. The first #335 production re-audit then found one remaining origin-symmetry defect: pre-registry implemented capabilities lacked the implementation version/time that future AI-originated capabilities receive, and future live registry↔authoring-binding consistency was not generically enforced. #354 repairs those two defects; after #354 production verification, #335 must be rerun read-only before #336. #325/#326 remain paused behind that cleanup chain.
...
1. **#58 capability-flow repair is active through #330 scientific-neutrality cleanup.** Canonical-capability transition #343 is complete through #348. #335's first read-only production audit found the implemented-capability origin-symmetry gap; #354 is the bounded repair. After #354 is production-green, rerun #335 read-only; #336 follows only after #335 is green. #325/#326 and scientific capability implementation remain paused until this chain is green.
