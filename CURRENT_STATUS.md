...
The aggregation case exposed both capability-flow defects and a scientific-context problem. #310–#312, #323/#324/#327/#328, the canonical-capability transition #343–#348, #354 and the #335 production re-audit are complete. The fresh scientific-acceptance follow-up produced #359–#362 and the exact connector cutover #367. The subsequent two-paper acceptance exposed duplicate request creation across overlapping papers. #376 reset that failed acceptance state. #375 is complete: the stable authoring/compiler skeleton is separated from implemented capability surfaces while preserving the existing hard authoring wall. #374 is complete: unsupported needs are born as unavailable structured candidate capabilities or candidate contract deltas, with covered/related later evidence attached to that same durable candidate instead of creating duplicate requests. #373 is the current repair: the Professor can deliberately broaden/refine an existing unavailable candidate while preserving its stable identity and evidence history. Next is #371 fresh two-paper acceptance. #325/#326 and scientific capability implementation remain paused until that acceptance chain is green.
...
1. **#58 capability-flow repair remains active through fresh scientific acceptance.** #376 restored the clean baseline and #375 completed the authoring/capability separation without softening validation. #374 is complete: structured unavailable candidates are created at request birth, reused by stable candidate identity, and collect `generalization_needed` evidence when later science is related but broader. #373 is current: Professor generalization revises that same candidate explicitly and auditably while it stays unavailable. The remaining successor is #371 fresh two-paper acceptance. #325/#326 and scientific capability implementation remain paused until that chain is green.
