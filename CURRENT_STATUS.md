...
1. **#58 capability-flow repair remains active through fresh scientific acceptance.** #376 restored the clean baseline after the overlapping-paper duplicate-request failure. #375 is the current architecture repair: stable authoring/compiler skeleton separated from implemented capability surfaces without softening validation. The planned sequence is #375 → #374 structured candidate creation/reuse → #373 Professor candidate generalization → #371 fresh two-paper acceptance. #325/#326 and scientific capability implementation remain paused until that chain is green.
