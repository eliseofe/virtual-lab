...
- **#425 Refactoring / technical debt** — living domain, active again from 24 September under the owner-approved plan in `docs/REFACTORING_AUDIT_2026-09-24.md`, executed one ticket at a time by Claude: #532 behaviour-preservation safety net, #533 reliable release loop, #535 proposal-first merging and #537 simulator core tidy-up (production-verified), then #541 shared database connection (in progress) and #543 styles out of JavaScript (not started).
