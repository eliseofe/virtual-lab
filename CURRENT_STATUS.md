...
1. **#58 capability-flow repair is active.** #310 adds the durable blocked-Experiment / closure-analysis foundation; #311 is the known next ticket and will change the Professor-side MCP request flow. Capability implementation (#305/#306 RNG and #304 heterogeneous initialization/state) is paused until the repair/acceptance sequence #310 → #311 → #312 → #313 is green.
