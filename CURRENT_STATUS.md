...
The bounded **#392 — Experiment revision time and actor provenance** and **#394 — Human identity** passes are complete. The owner-authorized **#396 — Experiment working copy and navigable revision history** mini-epic is now active under living UI/UX lane #273. Its first child **#397** establishes the persistence semantics: numbered Experiment revisions are retained immutable snapshots, human edits autosave into one unnumbered owner Working copy at interaction boundaries, and only explicit **Save Revision** crystallizes that Working copy. AI writes continue to create numbered revisions; a human Working copy can remain based on an older revision without merge/rebase or blocking when AI advances the head. The known successor **#398** will add the holistic revision selector/history UI and All/Mine/AI filtering; it has not started.
...
1. **#396 — Working copy and revision history is the active bounded UI/UX mini-epic.** #397 establishes immutable numbered snapshots plus durable human Working-copy autosave and explicit Save Revision. Its known successor #398 adds revision navigation/history and All/Mine/AI filtering; #398 has not started.
