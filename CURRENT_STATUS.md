...
1. **#58 capability-flow repair is active through #330 scientific-neutrality cleanup.** #331/#332/#333 are complete; #333 is production-verified and preserves capability memory as canonical generic definitions plus bibliographic provenance. #334 MCP surface cleanup is next; #335 then audits a fresh production session and #336 performs fresh-chat scientific acceptance. #325/#326 and capability implementation (#305/#306 RNG and #304 heterogeneous initialization/state) remain paused until this acceptance chain is green.
