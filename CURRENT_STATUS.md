...
1. **#58 capability-flow repair is active.** #310–#312, #323, #324 and diagnostic #327 are complete. #328 is active: fresh research-AI workspace discovery must expose caller-visible `requested`, `approved`, and `in_progress` capability commitments so pending owner-approved capabilities do not depend on chat memory. After #328 is production-green, #325 reruns the aggregation workflow from a fresh Grok chat; #326 then tests cross-session resume. Capability implementation (#305/#306 RNG and #304 heterogeneous initialization/state) remains paused until #313 closes.
