...
1. **#382 — Bare-bones scientific authoring language completeness is the active owner-prioritized epic.** #383 and #384 are complete. #385 is current: bounded Metrics booleans, comparisons and if/elif/else with browser/MCP ↔ Rust parity. The known successor is #386 closure/acceptance. #371 is paused until #386 is green.
