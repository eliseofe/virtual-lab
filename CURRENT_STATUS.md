...
The living **#273 — UI/UX refinement** lane has completed the Product Design activation through #423–#430 plus the evidence-driven refinements #437 and #440. The accepted result is a focused global ribbon plus one task-based Experiment Control panel with balanced peer-card proportions and a consistent action-button sizing system. The **Save & share** card now uses a short subtitle and one equal-size action bar for save/copy/move/share actions. Shared Experiment actions remain grouped around Current Experiment, Revisions, and Save & share; the Professor-only **Research curation** section contains Showcase publication/browsing and scientific Capability requests. Simulation/Arena and Experiment Source/Authoring remain otherwise unchanged. #273 is **dormant / living** until new concrete usage evidence appears.

## Immediate frontier

1. **#273 UI/UX is dormant / living after the completed Control-panel activation and direct-use refinements #437/#440.** No UI/UX child is currently executable; future work should be triggered by concrete use evidence rather than an automatic redesign successor.
