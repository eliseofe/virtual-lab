...
The living **#273 — UI/UX refinement** lane has completed the Product Design activation through #423–#430 plus the evidence-driven visual-balance refinement #437. The accepted result is a focused global ribbon plus one task-based Experiment Control panel with balanced peer-card proportions and a consistent action-button sizing system. Shared Experiment actions are grouped around Current Experiment, Revisions, and Save & share; the Professor-only **Research curation** section contains Showcase publication/browsing and scientific Capability requests. Simulation/Arena and Experiment Source/Authoring remain otherwise unchanged. #273 is **dormant / living** until new concrete usage evidence appears.

## Immediate frontier

1. **#273 UI/UX is dormant / living after the completed Control-panel activation and #437 balance refinement.** No UI/UX child is currently executable; future work should be triggered by concrete use evidence rather than an automatic redesign successor.
