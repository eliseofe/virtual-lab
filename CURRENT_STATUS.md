...
The aggregation case exposed both capability-flow defects and a scientific-context problem. #310–#312, #323/#324, diagnostic #327 and protocol-visibility repair #328 are complete. The fresh-chat follow-up then showed that exposing raw historical request context can feed a later research AI its own earlier scientific reasoning. Cleanup epic #330 is therefore active before acceptance resumes. #331 audited the full research-AI-visible surface; #332 froze the minimal scientific boundary; #333 and #334 are complete and production-verified. Owner review then identified the historically contingent split between request rows, capability truth and the authoring contract, so transition epic #343 was inserted before scientific acceptance. #344 froze the canonical six-class requirement taxonomy and the 11 implemented semantic capabilities. #345 is complete and production-verified: Supabase has an independent canonical capability registry with the 11 implemented capabilities plus normalized many-to-many publication provenance. #346 is complete: the research-AI request/closure path uses stable typed extension identity across all six owner-approved request classes, with all six Professor-visible and none automatically rejected. Semantic approvals bind or create canonical capability identity, publication identity is separate from reasoning, and one canonical engineering implementation may satisfy multiple approved request rows. The legacy request rows remain intact for final cutover. #347 authoring-contract/diagnostic ownership is next; #335/#336 and #325/#326 remain blocked behind the transition.
