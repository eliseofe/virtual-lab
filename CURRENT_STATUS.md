...
1. **#58 capability-flow repair remains active through fresh scientific acceptance.** #362 reset the acceptance artifacts; #361 and #360 are production-green. #359 is the next bounded ticket and will simplify the Professor extension inbox without changing request semantics. After #359, resume #336 fresh-chat scientific acceptance. #325/#326 and scientific capability implementation remain paused until that chain is green.
