...
The living **#273 — UI/UX refinement** lane has completed the Product Design activation through #423–#430 plus the evidence-driven refinements #437, #440, #444 and #446. The accepted result is a focused global ribbon plus one task-based Experiment Control panel with terse primary cards and intrinsic, responsive balance rather than fixed card sizing. Numbered revisions display only their number in the compact revision trigger; Working copy uses a compact marker with descriptive context retained in accessibility metadata. #444 removed stale local Control Panel integration glue; #446 then removed routine Save & share success prose, grouped Experiments with Organize under Current Experiment, and normalized Revisions, Save & share and Research curation around shared content-driven action layouts. Simulation/Arena and Experiment Source/Authoring remain otherwise unchanged. #273 is **dormant / living** until new concrete usage evidence appears; #425 remains dormant and no repo-wide refactor has been activated.

## Immediate frontier

1. **#273 UI/UX is dormant / living after the completed Control-panel activation and direct-use refinements #437/#440/#444/#446.** No UI/UX child is currently executable; future work should be triggered by concrete use evidence rather than an automatic redesign successor.
