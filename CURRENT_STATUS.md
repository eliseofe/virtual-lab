...
1. **#304 — generic heterogeneous per-agent private-state initialization is active and owner-authorized.** It implements deterministic per-agent initial values for Controller-declared private scalar state via Initialization, with no paper-specific informed/uninformed special case.
2. **#58 capability-flow remains operationally active.** The heterogeneous-state request `2616dbb5-2134-417f-aebb-2e9e4ea0dd9c` is in progress through #304. The separate target-observation request `0971db0e-015a-4f1f-b640-8cc6b428fdb7` remains requested and unavailable. #371 has not restarted.
