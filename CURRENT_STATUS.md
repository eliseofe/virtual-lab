...
The aggregation case exposed both capability-flow defects and a scientific-context problem. #310–#312, #323/#324, diagnostic #327 and protocol-visibility repair #328 are complete. The fresh-chat follow-up then showed that exposing raw historical request context can feed a later research AI its own earlier scientific reasoning. Cleanup epic #330 is therefore active before acceptance resumes. #331 audited the full research-AI-visible surface; #332 froze the minimal scientific boundary; #333 is complete and production-verified, adding canonical generic definitions plus minimal bibliographic provenance to the three existing capability rows without changing their UUIDs/lifecycle or deleting historical evidence. #334 is complete and production-verified: fresh research-AI sessions now receive formal Lab truth plus canonical capability metadata by default, while workspace science is explicit opt-in. #335 fresh-session production audit is next; #325/#326 remain paused until #330 is green.
...
1. **#58 capability-flow repair is active through #330 scientific-neutrality cleanup.** #331–#334 are complete and production-verified where applicable. Neutral MCP discovery now exposes the formal Lab contract plus global canonical capability memory without automatically returning Experiment/request discourse. #335 fresh-session production audit is next, followed by #336 fresh-chat scientific acceptance. #325/#326 and capability implementation (#305/#306 RNG and #304 heterogeneous initialization/state) remain paused until this acceptance chain is green.
