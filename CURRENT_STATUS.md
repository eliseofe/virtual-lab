...
The aggregation case exposed both capability-flow defects and a scientific-context problem. #310–#312, #323/#324/#327/#328, the canonical-capability transition #343–#348, #354 and the #335 production re-audit are complete. The fresh scientific-acceptance follow-up produced #359–#362 and the exact connector cutover #367. The subsequent two-paper acceptance exposed duplicate request creation across overlapping papers. #376 reset that failed acceptance state; #375–#373 completed the candidate architecture and Professor generalization repair. The next #371 black-box pass then exposed #380: source accepted by the JavaScript/MCP compiler could still produce IR rejected by the Rust runtime. #380 repairs that language boundary by canonicalizing ordinary Controller/Metrics collection aliases into the Rust-executable IR vocabulary and requiring an unconditional Controller action return. No scientific capability is added or made authorable. #371 is the planned fresh acceptance rerun after this repair is production-green. #325/#326 and scientific capability implementation remain paused until that acceptance chain is green.
...
1. **#58 capability-flow repair remains active through fresh scientific acceptance.** #375–#373 are complete. #371 exposed a validator/runtime wall defect before the two-paper overlap phase: JavaScript could certify IR that Rust rejected. #380 is the bounded repair, establishing canonical Controller/Metrics IR lowering plus basic syntax/mathematics parity and an unconditional Controller return invariant. The successor remains #371 fresh two-paper acceptance. #325/#326 and scientific capability implementation remain paused until that chain is green.
