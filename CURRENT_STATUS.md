...
1. **#382 — Bare-bones scientific authoring language completeness is the active owner-prioritized epic.** #383 is complete. #384 is current: standard scalar mathematics and `**` exponentiation aligned across the bounded artifact languages with native runtime operations. Successors are #385 Metrics control flow and #386 closure/acceptance. #371 is paused until #386 is green.
2. **#58 capability-flow remains operationally active**, with four current Constant Bearing scientific candidates in Supabase (closest-neighbour range, neighbour-centroid LOS rate, informed preferred direction, FoV-limited neighbours). Their implementation is not authorized by #382.
