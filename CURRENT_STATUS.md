...
1. **#382 — Bare-bones scientific authoring language completeness is the active owner-prioritized epic.** #383 is current: Controller booleans, scalar comparisons, boolean composition and if/elif/else with JS/MCP↔Rust parity. Successors are #384 standard scientific mathematics, #385 Metrics control flow, and #386 closure/acceptance. #371 is paused until #386 is green.
