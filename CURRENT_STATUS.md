...
1. **#58 capability-flow repair is active.** #310 — the durable blocked-Experiment / closure-analysis foundation — is complete and production-verified. #311 is the known next ticket and has not started; it will change the Professor-side MCP request flow. Capability implementation (#305/#306 RNG and #304 heterogeneous initialization/state) remains paused until the repair/acceptance sequence #311 → #312 → #313 is green.
