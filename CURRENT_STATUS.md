...
The bounded **#392 — Experiment revision time and actor provenance** and **#394 — Human identity** passes are complete. The owner-authorized **#396 — Experiment working copy and navigable revision history** mini-epic is at its final child under living UI/UX lane #273. **#397** and **#398** are production-complete: numbered revisions are retained immutable snapshots; human edits autosave into one unnumbered Working copy; explicit **Save Revision** crystallizes the next chronological revision; revision history is navigable from the Experiment header with All/Mine/AI filtering; and newer AI revisions become visible without replacing the current view or hiding human work. **#399** is the final integrated UX/regression pass and closes this bounded mini-epic when its exact candidate is production-green. Its candidate tightens old-revision Working-copy provenance, exact historical read-only copying, Mine/Human/AI attribution, dialog focus semantics, human-facing labels and mobile touch targets.
...
1. **#396 — Working copy and revision history is in its final bounded pass.** #397 and #398 are production-complete. #399 is the current and final substantial ticket: it verifies the whole revision workflow as one product experience and corrects only material integration friction. There is no successor inside #396; production-green #399 closes the mini-epic.
