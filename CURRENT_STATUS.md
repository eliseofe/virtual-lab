...
- **#425 Refactoring / technical debt** — living domain, active again from 24 September under the owner-approved plan in `docs/REFACTORING_AUDIT_2026-09-24.md`, executed one ticket at a time by Claude: #532 behaviour-preservation safety net, #533 reliable release loop, #535 proposal-first merging, #537 simulator core tidy-up, #541 shared database connection and #543 styles out of JavaScript and #545 revision behaviour tests (production-verified), then #547 Library behaviour tests (in progress) and #549 testing checkpoints and faster waits (not started).
