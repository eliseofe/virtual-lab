...
1. Repair #58's capability-request closed loop through #313 before implementing queued scientific capabilities. #310–#312 and #323/#324/#327/#328 are complete. Cleanup epic #330 remains the active gate. The inserted #343 canonical-capability transition has #344 inventory/classification, #345 canonical registry/provenance, #346 typed request/closure refactor and #347 authoring-contract/diagnostic ownership are complete; #348 production cutover/legacy retirement is next, followed by #335 fresh-session audit and #336 fresh-chat scientific acceptance. #325/#326 remain paused until this chain finishes.
