...
1. Continue #45 through bounded research-supervision collaboration slices. Professor read-only visibility (#287) and copy-to-own-workspace (#288) are production-complete; explicit sharing (#289) is active, followed by revocation/boundary completion (#290).
