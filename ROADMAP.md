...
1. Finish #58's capability-request closed loop before implementing scientific capabilities. #362 restored the clean acceptance baseline; #361 established pre-triage request reuse and scientific-language request identity; #360 established one durable blocked-Experiment closure/revalidation path for Student and Professor research AI; #359 makes the Professor inbox decision-oriented with durable evidence behind disclosure. #367 exact research-AI connector-surface cutover establishes the clean 9-tool canonical-only baseline; #336 fresh-chat scientific acceptance is next. #325/#326 remain paused until that chain finishes.
