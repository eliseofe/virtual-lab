...
1. Repair #58's capability-request closed loop through #313 before implementing the queued scientific capabilities. #310/#311 establish durable blocked-Experiment preservation and comprehensive Student/Professor submission; #312 adds Professor-side resume/revalidation; #323/#324 repaired fragmented repeated submission and reset the failed acceptance data; #327 verified the current authenticated submission path is healthy. #328 is complete and production-verified: caller-visible pending capability commitments are exposed in normal workspace discovery. #325 is next and reruns black-box Grok from a fresh chat without owner hints; #326 then verifies cross-session resume.
