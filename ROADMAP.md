...
1. Continue #45 through bounded research-supervision collaboration slices. Professor read-only visibility (#287) and copy-to-own-workspace (#288) are production-complete; explicit sharing is the #289 slice, with revocation/boundary completion (#290) recorded as its separate successor.
