...
1. Repair #58's capability-request closed loop through #313 before implementing the queued scientific capabilities. #310/#311 establish durable blocked-Experiment preservation and comprehensive Student/Professor submission; #312 adds Professor-side resume/revalidation; #323/#324 repaired fragmented repeated submission and reset the failed acceptance data; #327 verified the current authenticated submission path is healthy. #328 is active to expose caller-visible pending capability commitments in normal workspace discovery. Then #325 reruns black-box Grok from a fresh chat and #326 verifies cross-session resume.
