...
test("#313 historical reconciliation remains recorded while the current protocol uses stable typed identity", () => {
  ...
  assert.match(mcp, /candidate_capabilities/);\n  assert.match(mcp, /candidate_contract_deltas/);
